...
class CrosswordCreator():
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        def count_ruled_out_values(word):
            count = 0
            for neighbor in self.crossword.neighbors(var):
                if neighbor not in assignment:
                    # Count how many values in the neighbor's domain are ruled out by this word
        ...
        # Return the values sorted by the number of neighbors' values they rule out
