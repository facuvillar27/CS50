...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Probability of having the gene
        ...
        if mother is None or father is None:
            ...
            # Mother's gene inheritance probability
            if mother_genes == 2:
            ...
            # Father's gene inheritance probability
            if father_genes == 2:
            ...
            # Probabilities of inheriting genes
            if num_genes == 2:
